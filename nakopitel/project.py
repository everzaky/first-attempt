...
def ver7_11_1(Potreblenie, Prisoed_moshnost, KPD, Tsikli_Zar_i_Razradki, Stoimost_emkosti_nakop, Stoimost_PG,
    ...
    for i in range(len(Spisok)):
        if (Spisok[i][2] >= 0) and (NeZnayuKakNazvat1 == 0):
            ...
            plt.savefig('home/NeZnayuKakNazvat/first-attempt/site1/nakopitel/static/css/npv=0pck'+'.png',format='png')
        ...
        if (Spisok[i][3] >= 0) and (NeZnayuKakNazvat2 == 0) and (CK == 3 or CK == 4):
            ...
            print(Spisok[i][4])
            plt.plot(time,Spisok[i][4],time,Potreblenie)
            plt.savefig('home/NeZnayuKakNazvat/first-attempt/site1/nakopitel/static/css/npv=0sck' + '.png', format='png')
    ...
    if Spisok == []:
        ...
        if max_NPV > 0:
            ...
            plt.savefig('home/NeZnayuKakNazvat/first-attempt/site1/nakopitel/static/css/npvmaxpck' + '.png', format='png')
        ...
        if CK == 3 or CK == 4 and max_NPV0 > 0:
            ...
            plt.savefig('home/NeZnayuKakNazvat/first-attempt/site1/nakopitel/static/css/npvmaxsck' + '.png', format='png')
